...
class NEURAL_NETWORK:
    ...
    def Is_Motor_Neuron(self, n):
        return NEURON(n).Is_Motor_Neuron()

    def Get_Motor_Neurons_Joint(self, n):
        return NEURON(n).Get_Joint_Name()

    def Get_Value_Of(self, n):
        return NEURON(n).Get_Value()
# ---------------- Private methods --------------------------------------
